...
class srmswi
{
	protected $regno; //Registration Number of the Student.
	protected $pass; //Password of the Student.
	
	public $isAuthenticated; // User Authenitication Declaration
	 ...
	 * 
	 * 
	 * Curl Behaviour function..
	 * Set CURLOPT_RETURNTRANSFER to false for viewing in CURL format..
	 * 
	 * */
	 ...
	 * Login to the srmswi
	 */
	private function loginTosrmswi() {
		if (isset($this->regno) && isset($this->pass)) {
			$ch = $this->ch;
			
			curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/youLogin.jsp");
			...
			curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/youLogin.jsp");
		...
		} else die("Wrong details and it can't be used for hacking :)");
	}
	...
	public function getAttendance() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				...
				/**
				 * Fetch the Attendance from srmswi
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=7");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
	...
	public function getAttendanceDetails() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the Attendance Details from srmswi
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=25");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
	...
	public function getInternalMarks() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the Internal Marks from srmswi
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=22");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
				phpQuery::newDocument($html);
	...
	public function getGrades() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the Grades from srmswi
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=21");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
	...
	public function getCGPA() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the Grades Page from srmswi
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=21");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
	...
	public function getTimeTable() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the timetable from srmswi.
				 */	
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/academy/frmStudentTimetable.jsp");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
	...
	public function getHostelDetails() {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the Hostel Details from srmswi.
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=3");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
	...
	public function getCourses($sem = NULL) {
		if (isset($this->regno) && isset($this->pass)) {
			if($this->getAuthStatus()) {
				/**
				 * Get the Courses page from srmswi.
				 */
				$ch = $this->ch;
				curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=4");
				curl_setopt ($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
				$html = curl_exec($ch);
	 ...
	 */
        ...
        if (isset($this->regno) && isset($this->pass)) {
            if ($this->getAuthStatus()) {
                ...
                /**
                 * Get the Fee Due details from srmswi.
                 */
                $ch = $this->ch;
                curl_setopt($ch, CURLOPT_URL, "http://evarsity.srmuniv.ac.in/srmswi/resource/StudentDetailsResources.jsp?resourceid=20");
                curl_setopt($ch, CURLOPT_REFERER, "http://evarsity.srmuniv.ac.in/srmswi/usermanager/home.jsp");
                $html = curl_exec($ch);
